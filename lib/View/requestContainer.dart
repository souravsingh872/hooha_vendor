        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(child: Text("Action",style: TextStyle(fontSize: 11.sp,color: Colors.black),textAlign: TextAlign.left,)),
            ],
          ),
        ),
        Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded( flex:1,child: Container(height: 3.h,width: 10.w,
                              ...
                              child: Center(
                                child: Text("NEW",style: TextStyle(fontSize: 8.sp,color: Colors.white),),
                              ),
                            )),
                            SizedBox(width: 1.w,),
